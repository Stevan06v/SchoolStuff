...
class AccountManagerTest {
    ...
    void testGetBalanceNotExists() {
        ...
        assertThrows(AccountNotFoundException.class, () -> {
            double balance = accountManager.getBalanceForAccount("DE88200800000970375700");
        });
    }
    ...
    void testMultipleAccounts() throws AccountNotFoundException {
        ...
        balance = accountManager.getBalanceForAccount("AT022050302101023600");
    ...
    void testSerialization() throws IOException, ClassNotFoundException, AccountNotFoundException {
        ...
        double balance = accountManagerDeserialized.getBalanceForAccount("DE88200800000970375700");
        assertEquals(50.6, balance, 0.001);
        balance = accountManagerDeserialized.getBalanceForAccount("AT022050302101023600");

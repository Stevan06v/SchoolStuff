...
class FacilityRepositoryTest {
    ...
    @Test
    void testCreateCityIfNotExists() throws FacilityManagementException {
     /*   FacilityManagementException e = assertThrows(FacilityManagementException.class, () -> {
...
*/
    ...
    @Test
    void testFactoryAndRepositoryCitiesAreIdentical() throws FacilityManagementException {
    ...
    void testReadFromNotExistingFile() {
        ...
        //alternative because of JUnit incompatibility:
        assertEquals(true, e.getCause() instanceof IOException);
    }

    @Test
    void testReadFromCorruptFile() throws FacilityManagementException {
    ...
    @Test
    void testReadFromFilesAndGetSortedFacilitiesByZipCode() throws FacilityManagementException {

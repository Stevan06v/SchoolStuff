...
public class FacilityRepositoryTest {
    ...
    @Test
    public void testGetNotExistingCityByZipCode() {
    ...
    @Test
    public void testCreateCityIfNotExists() throws FacilityManagementException {
        FacilityManagementException e = assertThrows(FacilityManagementException.class, () -> {
    ...
    @Test
    public void testAddDuplicateFacility() {
    ...
    @Test
    public void testFactoryAndRepositoryCitiesAreIdentical() throws FacilityManagementException {
    ...
    @Test
    public void testReadFromCorruptFile() throws FacilityManagementException {
    ...
    @Test
    public void testReadFromFilesAndGetSortedFacilitiesByZipCode() throws FacilityManagementException {
